...
//	private ReadablePeriod paymentPeriod;
	...
	{
		self = initializeCashflowSet(currency, quantity, couponRate, tenorStartDate, tenor, compoundingRule );
	}
	...
	public CashflowSet(
		...
		Years          tenor ) 
	{
		self = initializeCashflowSet(currency, quantity, couponRate, tenorStartDate, tenor, Compounding.ANNUAL);
	}
