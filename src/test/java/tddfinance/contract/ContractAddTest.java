...
public class ContractAddTest {
	...
	public void getListTest() throws Exception {
		...
		contracts.add( new Cashflow(100, today.plus(Years.years(1)), Currency.USD) );
		contracts.add( new Cashflow(100, today.plus(Years.years(2)), Currency.USD) );
	...
	public void nextContractTest() throws Exception {
		...
		ContractAdd oneCashflow    = new ContractAdd(
			new Cashflow(100, today.plus(Years.years(2)), Currency.USD)
		);
		ContractAdd twoCashflows = new ContractAdd(
			new Cashflow(100, today.plus(Years.years(1)), Currency.USD),
			oneCashflow
		);
		ContractAdd threeCashflows  = new ContractAdd(
			new Cashflow(100, today, Currency.USD),
			twoCashflows
		);
	...
	public void nextSpunOffPositionsTest() throws Exception {
		...
		Contract threeCashflows = new ContractAdd(
			new Cashflow(100,                      today, Currency.USD),
			new Cashflow(50, today.plus(Years.years(1)),  Currency.USD),
			new Cashflow(60, today.plus(Years.years(2)),  Currency.USD)
		);
